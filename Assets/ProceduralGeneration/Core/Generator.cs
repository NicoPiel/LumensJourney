...
namespace ProceduralGeneration.Core
{
    ...
    public class Generator : MonoBehaviour
    {
        ...
        // Wall tiles
        [SerializeField] public GameObject wallTile;
        [Space]
        ...
        [Space]
        // Corner tiles
        [SerializeField] public GameObject wallCornerNw;
        ...
        [Header("Doors")]
        [SerializeField] public List<int[]> leftDoors;
        ...
        public bool Generate()
        {
            ...
            {
                Debug.LogError("Parameters were misconfigured. Check, if all your 'min..' values are less than or equal to your 'max..' values");
                return false;
            }
        ...
        private void GenerateCorridors(GameObject dungeon)
        {
            ...
            foreach (var doorRelation in doorRelations)
            {
                ...
                for (var x = buffer+1; x < rightDoorX; x++)
                {
                    if (width > 1)
                    {
                        if (x > middle-1)
